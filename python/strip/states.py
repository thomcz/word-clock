...
STUNDE = [_ZWOELF, _EINS, _ZWEI, _DREI, _VIER, _FUENF, _SECHS, _SIEBEN, _ACHT, _NEUN, _ZEHN, _ELF, _ZWOELF]
...
MINUTE = [[], _FUENF_NACH, _ZEHN_NACH, _VIERTEL_NACH, _ZWANZIG_NACH, _FUENF_VOR + _HALB, _HALB, _FUENF_NACH + _HALB, _ZWANZIG_VOR, _VIERTEL_VOR, _ZEHN_VOR, _FUENF_VOR]
