...
class LedStrip():
    ...
    def __init__(self):
        ...
        if LedStrip.__instance != None:
            ...
            self.strip = PixelStrip(ledconfig.LED_COUNT, ledconfig.LED_PIN, ledconfig.LED_FREQ_HZ, ledconfig.LED_DMA, ledconfig.LED_INVERT, ledconfig.LED_BRIGHTNESS, ledconfig.LED_CHANNEL, ledconfig.LED_STRIP)
            self.strip.begin()
