class WordclockStates():
    ...
    @staticmethod
    def getInstance():
        if WordclockStates.__instance == None:
            WordclockStates()
        return WordclockStates.__instance
    ...
    def __init__(self):
        ...
        if WordclockStates.__instance != None:
            ...
            WordclockStates.__instance = self

    def getPrefix(self):
        return WordclockStates._ES_IST

    def getPostfix(self):
        return WordclockStates._UHR

    def getHour(self):
        return WordclockStates._STUNDE

    def getMinute(self):
        return WordclockStates._MINUTE
